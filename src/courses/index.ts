...
import course2 from "./creole-languages-and-caribbean-identities.json";
import course3 from "./introduction-to-computer-science-and-programming-in-python.json";
import course4 from "./single-variable-calculus.json";
